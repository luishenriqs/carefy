...
let ShowPhysicianByNameService = (_dec = (0, _tsyringe.injectable)(), _dec2 = function (target, key) {
  return (0, _tsyringe.inject)('PhysiciansRepository')(target, undefined, 0);
}, _dec3 = Reflect.metadata("design:type", Function), _dec4 = Reflect.metadata("design:paramtypes", [typeof _IPhysiciansRepository.default === "undefined" ? Object : _IPhysiciansRepository.default]), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = class ShowPhysicianByNameService {
  constructor(physiciansRepository) {
    this.physiciansRepository = physiciansRepository;
  }

  async execute(medicalSpecialty) {
...
var _default = ShowPhysicianByNameService;
